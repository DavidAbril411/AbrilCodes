...
import ExpandableCard, { ExpandProvider } from "../ExpandableCard";

export default function Services() {
  return (
    <section className="max-w-[100vw] overflow-hidden relative pt-[clamp(20px,5vw,80px)]">
      <div className="flex flex-col items-center justify-center  pb-[clamp(20px,10vw,200px)] px-4 gap-14">
        <h2 className="text-[clamp(15px,2.8vw,30px)] font-semibold text-[#fff]">
          My Services
        </h2>
        <ExpandProvider>
          <div className="flex flex-col md:flex-row justify-between gap-6 w-full max-w-[1100px]">
            <ExpandableCard
              id="design"
              title="Custom Design"
              description="We develop unique designs that reflect your identity and needs without generic templates. Every detail is considered to make your website truly one of a kind."
              fullDescription="Our design philosophy centers on creating custom experiences that truly represent your brand. We begin with understanding your vision, audience, and goals before crafting a unique design language specifically for you. Our designers work closely with you throughout the process, ensuring every color, font, and layout element serves your objectives while standing out from template-based solutions. We focus on creating intuitive interfaces that guide users naturally through your content while maintaining visual appeal across all devices."
            ...
            <ExpandableCard
              ...
              description="We build responsive websites with clean, efficient code that works flawlessly across all devices."
              fullDescription="We don’t just design we build websites using modern technology, prioritizing speed, security, and scalability. We use tools such as Next.js, Node.js, and Docker to deliver superior performance."
              subtitle="What does this mean for your business?"
              bottomRightDescription="A professional development approach ensures your website operates efficiently and without limitations, adapting to your business’s present and future needs."
              direction="center"
              ...
              items={[
                {
                  title: "Faster speed",
                  description:
                    "Websites up to 4 times faster than traditional ones.",
                },
                {
                ...
                },
                {
                  title: "Scalability",
                  description:
                    "Handles high traffic without compromising performance.",
                },
                {
                  title: "Total flexibility",
                  description:
                    "No reliance on third-party templates or plugins.",
                },
              ]}
            />
