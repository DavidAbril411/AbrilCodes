...
export default function About() {
    return (
        <section className="w-full h-[800px] relative flex items-center justify-center mt-10 transform translate-y-[7px] -z-10">
            <div
                className="absolute -top-[77px] h-[950px] left-0 -z-40 w-[70%]"
                style={{
                    background: "linear-gradient(90deg, #31315D99, #1A1A64)",
                }}
            >
            </div><div
                className="absolute -top-[77px] h-[950px] left-[70%] -z-40 w-[30%]"
                style={{
                    background: "#1A1A64",
                }}
            >
            ...
            <img
                src={FondoLaptop.src}
                alt=""
                className="absolute -left-[139px] -z-50 w-[90%] opacity-30"
            />
                ...
                <div className="flex flex-col items-start px-6">
                    ...
                    <p className="leading-tight pt-[clamp(0px,1vw,12px)] hidden md:block">
                        <span className="text-[clamp(11px,1.7vw,20px)] font-extralight text-[#FFFFFF] flex-nowrap text-nowrap">
                            I&apos;m David Abril, a professional developer with an
                            8.75/10 GPA in
                        </span>
                        <br />
                        <span className="text-[clamp(11px,1.7vw,20px)] font-extralight text-[#FFFFFF] flex-nowrap text-nowrap">
                            Computer Engineering. After 6 months at MindFactory,
                            I ventured
                        </span>
                        <br />
                        <span className="text-[clamp(11px,1.7vw,20px)] font-extralight text-[#FFFFFF] flex-nowrap text-nowrap">
                            out to merge creativity and technology into unique
                            projects.
                        </span>
                        <br />

                        <span className="text-[clamp(11px,1.7vw,20px)] font-extralight text-[#FFFFFF] flex-nowrap text-nowrap">
                            At Abril Codes, I collaborate with a talented team:
                            Valentina Correa
                        </span>
                        <br />
                        <span className="text-[clamp(11px,1.7vw,20px)] font-extralight text-[#FFFFFF] flex-nowrap text-nowrap">
                            (graphic designer) and Francisco Ameri (software
                            engineer and
                        </span>
                        <br />
                        <span className="text-[clamp(11px,1.7vw,20px)] font-extralight text-[#FFFFFF] flex-nowrap text-nowrap">
                            project manager), blending innovative design with
                            robust code. We
                        </span>
                        <br />
                        <span className="text-[clamp(11px,1.7vw,20px)] font-extralight text-[#FFFFFF] flex-nowrap text-nowrap">
                            dream of revolutionizing the digital world while
                            building a balanced
                        </span>
                        <br />
                        <span className="text-[clamp(11px,1.7vw,20px)] font-extralight text-[#FFFFFF] flex-nowrap text-nowrap">
                    ...
                    <p className="text-[9px] text-[#fff] text-center w-[clamp(228px,40vw,470px)] block md:hidden">
                        I’m David Abril, a professional developer with an
                        8.75/10 GPA in Computer Engineering. After 6 months at
                        MindFactory, I ventured out to merge creativity and
                        technology into unique projects. At Abril Codes, I
                        collaborate with a talented team: Valentina Correa
                        (graphic designer) and Francisco Ameri (software
                        engineer and project manager), blending innovative
                        design with robust code. We dream of revolutionizing the
                        digital world while building a balanced life near the
                        ocean.
                    </p>
                </div>
                {
